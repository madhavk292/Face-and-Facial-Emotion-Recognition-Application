...
# # face recognition
# face_recognition_model = pickle.load(open(os.path.join(STATIC_DIR,'models/machinelearning_face_person_identity_sports.pkl'),
#                                           mode='rb'))
# # emotion recognition model
# emotion_recognition_model = pickle.load(open(os.path.join(STATIC_DIR,'models/machinelearning_face_emotion_sports.pkl'),mode='rb'))
